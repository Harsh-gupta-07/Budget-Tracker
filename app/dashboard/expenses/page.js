...
const page = () => {
  ...
  const categories = [
    { category: "Personal", budget: 400, icon: "bag", spent: 100, id: 1 },
  ];
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <div className="flex flex-row bg-[#1b1d1e] py-5 justify-between align-middle w-full px-8">
            <div>
              <h1 className="text-2xl font-semibold inline align-middle mt-1.25">
                Expenses
              </h1>
            </div>
            <button
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <div className="dropdown dropdown-end w-full bg-[#080808] sm:w-64 border rounded border-solid border-gray-500">
                ...
                >
                  {selectedCategory === -1
                    ? "All Categories"
                    : categories[parseInt(selectedCategory)]?.category ||
                      "All Categories"}
                  <svg
                ...
                >
                  ...
                  {categories.map((cat, index) => (
                    <li key={cat.id}>
                      <a onClick={() => setSelectedCategory(index)}>
                        {cat.category}
                      </a>
                    </li>
                  ))}
