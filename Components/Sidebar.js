...
const Sidebar = () => {
  ...
  return (
    <ul className="bg-[#181a1b] h-screen w-65 py-4 px-0 text-gray-300 border-r-1 border-gray-700 flex flex-col justify-between">
      <div>
              ...
              >
                ...
                <g id="SVGRepo_iconCarrier">
                  <path
                    ...
                    fill={
                      usePathname() === "/dashboard" ? "#3e9bf7" : "#b0a99e"
                    }
                  />
                  <path
      ...
      <li className="mt-4 px-6 pb-2">
        <button
          onClick={() => {
            setShowConfirmLogout(true);
          }}
          className="w-full bg-[#232526] hover:bg-[#2c2f31] text-red-400 font-semibold py-2 rounded-lg transition duration-200 border border-[#232526] cursor-pointer"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
      ...
      {showConfirmLogout && (
        <ConfirmLogout visible={() => setShowConfirmLogout(false)} logout={logout} />
      )}
    </ul>
  );
};
